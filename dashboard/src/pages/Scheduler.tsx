    ...
    <div>
      <div className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">Schedule automated task executions</p>
        </div>
        <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-500">
                      <div>
                        <span className="font-medium">Schedule:</span> {getScheduleDescription(task.schedule)}
                      </div>
                      <div>
                        <span className="font-medium">Input File:</span> {task.inputFile}
                      </div>
                      <div>
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 md:w-1/2 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              ...
              <form onSubmit={handleCreateTask} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Input File Path</label>
                  <input
                    type="text"
                    required
                    value={newTask.inputFile}
                    onChange={(e) => setNewTask({ ...newTask, inputFile: e.target.value })}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Output File Path (optional)</label>
                  <input
                    type="text"
                    value={newTask.outputFile}
                    onChange={(e) => setNewTask({ ...newTask, outputFile: e.target.value })}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setNewTask({ ...newTask, isDryRun: e.target.checked })}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="isDryRun" className="ml-2 block text-sm text-gray-900">
